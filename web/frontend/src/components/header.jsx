    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-linear-to-r from-white via-gray-50 to-white text-gray-700 shadow-2xl overflow-hidden" style={{ backgroundSize: '200% 200%', animation: 'flow 6s ease-in-out infinite' }}>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-6 flex justify-between items-center relative z-10">
        ...
        <div className="flex items-center space-x-1 sm:space-x-2">
          <div className="w-8 h-8 sm:w-10 sm:h-10 bg-green-100 text-green-600 rounded-full flex items-center justify-center transform hover:rotate-12 transition-transform duration-300">
            <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 2a10 10 0 00-7.53 16.59l-1.42 1.42a1 1 0 001.41 1.41l1.42-1.42A10 10 0 1012 2z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 18a6 6 0 006-6c0-2-1-3.73-2.5-4.95"></path>
            </svg>
          </div>
          <h1
        ...
        <nav className="hidden md:flex space-x-6 lg:space-x-10">
          {isBuyerMode ? (
            ...
            <>
              ...
              <button onClick={() => handleNavigation('/transporter-available-jobs')} className="flex items-center space-x-1 relative group hover:text-orange-600 transition-all duration-300 font-medium">
                ...
                <span>{t('header.availableJobs')}</span>
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-orange-600 group-hover:w-full transition-all duration-300"></span>
              </button>
              <button onClick={() => handleNavigation('/transporter-my-deliveries')} className="flex items-center space-x-1 relative group hover:text-orange-600 transition-all duration-300 font-medium">
                ...
                <span>{t('header.myDeliveries')}</span>
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-orange-600 group-hover:w-full transition-all duration-300"></span>
              </button>
          ...
          <button
            ...
            className="flex items-center space-x-1 px-3 py-1 rounded-full border border-gray-300 hover:border-green-500 hover:text-green-600 transition-all duration-300"
          >
