      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-6 flex justify-between items-center relative z-10">
        ...
        <nav className="hidden md:flex space-x-6 lg:space-x-10">
          {isBuyerMode ? (
            ...
            <>
              <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="flex items-center space-x-1 relative group hover:text-green-600 transition-all duration-300 font-medium">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button onClick={() => handleSmoothScroll('features')} className="flex items-center space-x-1 relative group hover:text-green-600 transition-all duration-300 font-medium">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button onClick={() => handleSmoothScroll('how-it-works')} className="flex items-center space-x-1 relative group hover:text-green-600 transition-all duration-300 font-medium">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button onClick={() => handleSmoothScroll('about')} className="flex items-center space-x-1 relative group hover:text-green-600 transition-all duration-300 font-medium">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button onClick={() => handleSmoothScroll('contact')} className="flex items-center space-x-1 relative group hover:text-green-600 transition-all duration-300 font-medium">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
