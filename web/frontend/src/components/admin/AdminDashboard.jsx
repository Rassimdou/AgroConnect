...
const AdminDashboard = () => {
    ...
    const fetchStats = async () => {
        try {
            ...
            // Use real data from API but mock revenue and calculate activeTransporters
            const apiData = response.data;
            setStats({
                ...apiData,
                overview: {
                    ...apiData.overview,
                    totalRevenue: 45200, // Mocked revenue as requested by user
                    activeTransporters: Math.floor(apiData.overview.totalTransporters * 0.9) // Estimate 90% are active
                }
            });
            setLoading(false);
        } catch (err) {
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <StatCard
                    ...
                    value={stats?.overview?.activeTransporters}
                    icon={Truck}
                    color="bg-orange-500"
                    trend={-2.1}
                />
