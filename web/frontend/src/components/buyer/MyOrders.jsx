...
const MyOrders = () => {
  ...
  const handleTrackShipment = (order) => {
    if (order.trackingNumber) {
      alert(t('orders.alerts.tracking', { trackingNumber: order.trackingNumber, status: getStatusLabel(order.status) }));
    } else {
      alert(t('orders.alerts.noTracking'));
    }
  };

  const handleLeaveReview = (order) => {
    alert(t('orders.alerts.review', { id: order.id }));
  };
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 border-b border-gray-200">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-gray-900">{t('orders.orderId', { id: order.id })}</h3>
                ...
                <div className="p-6">
                  ...
                  <div className="mt-8 flex flex-col sm:flex-row gap-4">
                    ...
                    >
                      ...
                      {order.trackingNumber ? t('orders.trackShipment') : t('orders.trackOrder')}
                    </button>
          ...
          {ordersData.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-4">{t('orders.noOrders')}</h3>
              <p className="text-gray-600 mb-8 text-lg max-w-md mx-auto">{t('orders.noOrdersDesc')}</p>
