            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="mt-6 md:mt-0 flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="bg-transparent border border-white/70 text-white px-8 py-3 rounded-xl font-semibold hover:bg-white/10 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  Logout
                </button>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-100 hover:border-blue-200 group cursor-pointer transform hover:scale-105">
            ...
            <div>
              ...
              <button
                ...
                className="text-green-600 font-semibold text-sm flex items-center group-hover:translate-x-1 transition-transform duration-300"
              >
                View Details →
              </button>
            </div>
              ...
              <div className="flex items-end space-x-1 h-8 mb-2">
                {dashboardData.marketTrends.slice(-5).map((point, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="bg-green-600 rounded-sm flex-1 min-w-1 shadow-sm"
