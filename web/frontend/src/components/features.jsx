  ...
  const features = [
    {
      ...
      description: "Seamlessly connect producers, buyers, and transporters in one digital marketplace across all 48 Algerian wilayas."
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Access live market prices and trends to make informed decisions and optimize your agricultural business."
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Efficient transportation coordination with real-time tracking and optimized delivery routes across Algeria."
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Safe and secure payment processing with multiple options including mobile money and bank transfers."
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Comprehensive data insights and analytics to help you understand market trends and make better business decisions."
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Verified suppliers and quality control measures to ensure you get the best agricultural products and services."
    }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className={`text-center mb-12 sm:mb-16 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-800 mb-4">
            Why Choose <span className="text-green-600">AgroConnect DZ</span>?
          </h2>
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4">
            Our digital marketplace revolutionizes agricultural commerce in Algeria by connecting all stakeholders in one efficient platform.
          </p>
        </div>
        ...
        <div className={`text-center mt-12 sm:mt-16 transform transition-all duration-1000 delay-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="bg-green-600 text-white rounded-2xl p-6 sm:p-8 lg:p-12 shadow-2xl">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4">Ready to Transform Your Agricultural Business?</h3>
